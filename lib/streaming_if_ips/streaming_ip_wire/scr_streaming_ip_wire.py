...
from sim_streaming_ip_wire import sim_streaming_ip_wire, check_simulation_results
from streaming_ip_wire_convert import streaming_ip_wire_convert

#------script parameters------#
DEF_VALID_READY=0xffff
DEFAULT_SIM_TIME=2000
TB_NAME = 'sim_streaming_ip_wire'           # test file
SYNTHESIS_TOP = 'syn_streaming_ip_wire_top' # synthesis top level
