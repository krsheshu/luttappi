...
def sim_lR_1vsAll(pars_obj):
  ...
  inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta0, pipe_out_activ0 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta1, pipe_out_activ1 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta2, pipe_out_activ2 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta3, pipe_out_activ3 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta4, pipe_out_activ4 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta5, pipe_out_activ5 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta6, pipe_out_activ6 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta7, pipe_out_activ7 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta8, pipe_out_activ8 ))   
  #inst.append(moduleLR.block_connect(pars, reset, clk, pipe_inpA, pipe_theta9, pipe_out_activ9 ))   
  ...
  def transmit_data_process():
    ...
    if (shiftEn_i == 1 and nbTA == nbTB and nbTA < MAX_NB_TRANSFERS):
      ...
      pipe_theta0.data.next = (theta_file_list[line_nb])
