...
from streaming_simple_modsub import StreamingSimpleModSubPars, StreamingSimpleModSub
...
def sim_streaming_simple_modsub(pars_obj):
  PATTERN_WIDTH = 16
  DATA_WIDTH = 8
  ...
  modsub_pars=StreamingSimpleModSubPars()
  modsub_pars.SNK0_DATA_WIDTH=DATA_WIDTH
  modsub_pars.SNK1_DATA_WIDTH=DATA_WIDTH
  modsub_pars.SRC_DATA_WIDTH=DATA_WIDTH
  modsub_pars(modsub_pars)
  modsub_i=StreamingSimpleModSub()
  ...
  streaming_simple_modsub_inst = modsub_i.block_connect(modsub_pars, reset, clk, av_snk0, av_snk1, av_src)
  ...
  def beh_comb_logic():
    ...
    av_snk1.data_i.next  = av_src1_bfm.data_o + 1
