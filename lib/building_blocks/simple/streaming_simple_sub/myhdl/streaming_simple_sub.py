...
class StreamingSimpleSubPars():
  def __init__(self):
    """ streaming_simple sub pars """
...
class StreamingSimpleSub():
  """ StreamingSimpleSub Top """
  def __init__(self):
    pass

  def block_connect(self, pars, reset, clk, av_snk0, av_snk1, av_src):
    """ streaming_simple sub block"""
    ...
    def streaming_simple_sub():
      """ streaming_simple sub """
      if reset==1:
