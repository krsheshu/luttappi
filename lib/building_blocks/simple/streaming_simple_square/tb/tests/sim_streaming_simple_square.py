...
from streaming_simple_square import StreamingSimpleSquarePars, StreamingSimpleSquare
...
def sim_streaming_simple_square(pars_obj):
  ...
  streaming_simple_square_inst = square_i.block_connect(square_pars, reset, clk, av_snk0, av_snk1, av_src)
...
def check_simulation_results(pars_obj):
  ...
  print "Operation intended: Squaring"
  ...
  if (len(recv_data) < MAX_NB_TRANSFERS):
    ...
    if (err_cnt):
      ...
      print "Receive and transmit data exactly matches for squaring..." 
