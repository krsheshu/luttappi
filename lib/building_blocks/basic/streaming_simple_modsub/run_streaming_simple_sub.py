...
from sim_streaming_simple_modsub import sim_streaming_simple_modsub, check_simulation_results
#from streaming_simple_modsub_convert import streaming_simple_modsub_convert

#------script parameters------#
DEF_VALID_READY=0xffff
DEFAULT_SIM_TIME=2000
TB_NAME = 'sim_streaming_simple_modsub'           # test file
SYNTHESIS_TOP = 'syn_streaming_simple_modsub_top' # synthesis top level
...
def myhdl_module_cli():
  ...
  if args.convert:
    ...
    #streaming_simple_modsub_convert()
  if args.simulate:
